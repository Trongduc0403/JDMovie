...
{
    public class CttapPhimsController : Controller
    {
        private readonly dbDACNContext _context;

        public CttapPhimsController(dbDACNContext context)
        {
            _context = context;
        }
